...
I2(:,:,1)=interp2(0:size(I,2)-1, 0:size(I,1)-1,double(I(:,:,1)),xi,yi,meth,NaN);
I2(:,:,2)=interp2(0:size(I,2)-1, 0:size(I,1)-1,double(I(:,:,2)),xi,yi,meth,NaN);
I2(:,:,3)=interp2(0:size(I,2)-1, 0:size(I,1)-1,double(I(:,:,3)),xi,yi,meth,NaN);
